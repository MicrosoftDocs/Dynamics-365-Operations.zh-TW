...
| 內容  | 描述 | 格式  | 長度    |
|----------|-------------|---------|-----------|
| [使用 Success by Design for Dynamics 365 解決方案](/learn/paths/use-success-design/) | FastTrack for Dynamics 365 設計著重在幫助客戶和合作夥伴成功部署 Dynamics 365 解決方案。 為了提供本服務，解決方案架構師應該使用 Success by Design。 此學習路徑討論 Success by Design 概念。 | 免費、步調自訂的線上學習單元 | 12 小時 |
| [使用 Lifecycle Services 設計和計劃財務和營運應用程式的落實工作](/learn/paths/use-lcs-design-plan-implementation-finance-operations/) | Lifecycle Services (LCS) 屬於共同作業工作區，客戶與其合作夥伴都能用它管理從預售到落實階段，最終到正式環境的財務和營運應用程式專案。 它提供能幫助您管理專案的核對清單和工具，包括有助於落實和定期更新服務的預建構式方法論。 | 免費、步調自訂的線上學習路徑 | 2 小時 |
...
| [使用財務和營運應用程式遷移資料與上線直播](/learn/paths/migrate-data-go-live-finance-operations/) | 身為功能顧問，您必須了解如何讓您的客戶準備好資料遷移、搭配資料管理和執行使用者驗收測試，以便借助財務和營運應用程式上線直播。 | 免費、步調自訂的線上學習路徑 | 4 小時 |
...
| [落實財務和營運應用程式](/learn/paths/implement-finance-operations/) | 了解管理成功的財務和營運應用程式實施專案的最重要元素和最佳實務做法。 從規劃和設計專案方法論第一步、FastTrack 服務的使用、發展策略、資料管理等，到直播上線後維護和監視營運的最佳方式。 | 免費、步調自訂的線上學習路徑 | 11.5 小時 |
| [財務和營運應用程式：Dynamics 365 (DYN542PAL2) 上線](https://community.dynamics.com/365/b/techtalks/posts/finance-and-operations-onboarding-to-dynamics-365-1-10-19) | FastTrack 為每個 Dynamics 365 for Finance and Operations 專案提供上線服務。 我們將在 TechTalk 解釋上線流程，與您一起逐步完成上線工作階段的內容，並且揭開我們如何在不久的未來使上線更有效率和便利。 這段工作階段與專案早期階段、完成授權交易和啟動實施專案之間搭配客戶工作的每個人都特別相關。 | 技術論壇 (現場錄影的網絡研討會) | 62 分鐘 |
| [內部部署 (區域業務資料) 部署 (DYN382PAL2)](https://community.dynamics.com/365/b/techtalks/posts/on-premises-local-business-data-deployment-october-19-2017) | 請加入這場技術論壇，一同了解 Dynamics 365 for Finance and Operations Enterprise Edition 內部部署選項的概觀。 我們將在這場論壇端詳內部部署的解決方案架構、ALM 層面、系統要求及如何佈建 Life Cycle Services 專案。 | 技術論壇 (現場錄影的網絡研討會) | 48 分鐘 |
| [直播上線規劃 (DYN458PAL2)](https://community.dynamics.com/365/b/techtalks/posts/go-live-planning-8-9-18) | 我們將詳細討論上線流程，以及如何最足妥善的準備，讓客戶、合作夥伴和 Microsoft 盡可能順利完成。 | 技術論壇 (現場錄影的網絡研討會) | 60 分鐘 |
...
| [Analytics & Reporting 選項：Printing 和 Document Routing Agent](https://community.dynamics.com/365/b/techtalks/posts/analytics-amp-reporting-options-printing-and-the-document-routing-agent-february-8-2018) | 本回合將討論 D365 for Operations 的各種列印狀況，包括 Document Routing Agent 的訣竅和技巧。 | 技術論壇 (現場錄影的網絡研討會) | 60 分鐘 |
...
## <a name="migration-and-upgrades"></a>遷移與升級<a name="migration"></a>

| 內容  | 描述  | 格式  | 長度    |
|----------|--------------|---------|-----------|
| [升級 Dynamics AX 2012 為財務和營運應用程式](/learn/paths/upgrade-ax-2012-finance-operations/) | 了解成功升級 Dynamics AX 2012 解決方案為財務和營運應用程式的最重要元素和最佳實務做法。 從發現關鍵架構差異第一步、開始升級流程、代碼和資料升級工具，到以最新功能重新設計整合、分析和報表的最佳方式。 | 免費、步調自訂的線上學習路徑 | 7 小時 |
...
| [在 Dynamics 365 Finance 配置和使用預算](/learn/paths/configure-use-budgeting-dyn365-finance/) | 每間組織，不論私營或公營，都會藉由建立預算設定財務和營運目標。 憑藉預算規劃的共同作業和流程導向性質，您可以提高預算流程的效率。 | 免費、步調自訂的線上學習路徑 | 2.5 小時 |
...
| [配置公家機關適用的 Dynamics 365 Finance](/learn/modules/configure-public-sector-dyn365-finance/) | Dynamics 365 Finance 促使業務流程成為公家機關和私人機構常用流程，例如編列預算、採購、應付帳款和應收帳款任務。 使用公家機關功能符合服務公家機關的組織規則、法規和報表編製要求。 | 免費、步調自訂的線上單元 | 1.5 小時 |
| [配置 Dynamics 365 Finance 的電子報表](/learn/modules/configure-electronic-reporting-finance-operations/) | 企業使用者沒有單行程式碼就能配置和使用電子報表工具，而不是擴充 Dynamics 365 Finance 程式碼只為了符合不同國家或地區的監管功能與法令遵循。 例如，您可以採用新的監管要求和產生必要格式的業務文件，以便與政府機構、銀行和其他各方進行電子資訊交換。 | 免費、步調自訂的線上單元 | 3 小時 |
